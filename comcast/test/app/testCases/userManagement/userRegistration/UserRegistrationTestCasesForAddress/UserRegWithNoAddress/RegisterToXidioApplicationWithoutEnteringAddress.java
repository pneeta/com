...
public class RegisterToXidioApplicationWithoutEnteringAddress extends BaseTest{
	...
	public void testRegisterToXidioApplicationWithoutEnteringAddress() throws Exception {
	    ...
	    userRegValidationFun.validateUserRegistrationFields(driver,DataServiceProperties._FIRST_NAME,DataServiceProperties._LAST_NAME,"",DataServiceProperties._CITY,DataServiceProperties._STATE,DataServiceProperties._ZIP,DataServiceProperties._REG_PASSWORD);
