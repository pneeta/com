...
/** 
 * Class Name: VerifyUpdatedStatusForHomeFeaturedShows
 * Description: This test case is to verify the shown last updated status/day
 * for a Shows displayed under 'Featured' Channel section on 'Home' screen
...
public class VerifyUpdatedStatusForHomeFeaturedShows extends BaseTest{
	...
	@Test
	public void testVerifyUpdatedDayForHomeFeaturedShows() throws Exception {
