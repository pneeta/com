 ...
 * Description: This test case validates whether the Shows are displayed under Popular Shows section in Home page by 
 *  logging registered user into Comcast application.
 * **/

public class VerifyShowsAreDisplayedUnderHomePopularShowsCategoryPage extends BaseTest{
	
	RegisterToXidioApplicationAndChangeAPassword RegUserAndChangePass=new RegisterToXidioApplicationAndChangeAPassword();
	
	@Test
	public void testVerifyShowsAreDisplayedUnderPopularShowsCategory() throws Exception {
		...
		{
			System.out.println("Show List:>>"+popularShowList.get(i).getTitle());
		}
	    ...
	    Thread.sleep(sleepTime);
    	driver.findElement(By.partialLinkText(popularShowList.get(0).getTitle())).click();
