...
public class PlayHomeFeaturedVideoBySelectingChannelAndThenShow extends BaseTest
{
	...
	public void testPlayHomeFeaturedVideoBySelectingChannelAndThenShow() throws Exception {
	    ...
	    /*
	     * In Video Response we are getting spaces between the text so test case is failing 
	     * Below commented lines will execute by taking xpath.
	     */	     	    
	    ...
	    Thread.sleep(sleepTime);
	    String videoTitle=videoList.get(0).getTitle();
	    driver.findElement(By.partialLinkText(videoTitle)).click();
