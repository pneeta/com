 ...
 * displayed under channel page from 'Popular Channels' section on 'Home' screen
 * **/

public class PlayHomePopularChannelsVideoBySelectingChannelAndThenShow extends BaseTest{
	
	RegisterToXidioApplicationAndChangeAPassword RegUserAndChangePass=new RegisterToXidioApplicationAndChangeAPassword();
	
	@Test
	public void testPlayPopularChannelsVideoBySelectingChannelAndThenShow() throws Exception {
