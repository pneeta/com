...
/**
 * Class Name: PlayHomePopularChannelsVideoFromRowsByClickingOnShow 
 * Description: This test case is to play the video from Rows category by  
 * selecting the shows in the channel page for 'Popular Channels' section in Home page.
 * **/

public class PlayHomePopularChannelsVideoFromRowsByClickingOnShow extends BaseTest{
	
	RegisterToXidioApplicationAndChangeAPassword RegUserAndChangePass=new RegisterToXidioApplicationAndChangeAPassword();
	
	@Test
	public void testPlayHomePopularChannelsVideoFromRowsByClickingOnShow() throws Exception {
