...
/** 
 * Class Name: PlayPopularVideoBySelectingChannelAndThenShows
...
public class PlayPopularVideoBySelectingChannelAndThenShows extends BaseTest{
	
	RegisterToXidioApplicationAndChangeAPassword RegUserAndChangePass=new RegisterToXidioApplicationAndChangeAPassword();
	
	@Test
	public void testPlayPopularVideoBySelectingChannelAndThenShow() throws Exception {
    	...
    	driver.findElement(By.linkText(showList.get(2).getTitle())).click();
