package comcast.test.app.testCases.videoManagement.videoStoreManagement.FeaturedCategoryTestCases.ChannelTestCases.VideosCategory;
...
/** 
 * Class Name: VerifyVideosUnderChannelForFeatured
 * Description: This test case is to verify the available options of videos
 * after sorting by 'VIDEOS'for a channel displayed under 'Featured' section on 'Store' screen 
 * by logging into Comcast application.
 */

public class VerifyVideosUnderChannelForFeatured extends BaseTest{
	
	RegisterToXidioApplicationAndChangeAPassword RegUserAndChangePass=new RegisterToXidioApplicationAndChangeAPassword();
	
	@Test
	public void testVerifyVideosUnderChannelForFeatured() throws Exception {
