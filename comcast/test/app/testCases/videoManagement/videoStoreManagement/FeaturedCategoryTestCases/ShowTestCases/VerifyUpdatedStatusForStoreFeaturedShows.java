...
/** 
 * Class Name: VerifyUpdatedStatusForAFeaturedShows
 * Description: This test case is to verify the shown last updated status/day
 * for a Shows displayed under 'Featured' Channel section on 'Store' screen
 * by logging into Comcast application.
 */

public class VerifyUpdatedStatusForStoreFeaturedShows extends BaseTest{
