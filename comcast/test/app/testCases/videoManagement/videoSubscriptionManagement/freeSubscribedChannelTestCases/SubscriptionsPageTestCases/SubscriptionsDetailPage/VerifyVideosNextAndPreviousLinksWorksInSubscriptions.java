...
/** 
 * Class Name: VerifyVideosNextAndPreviousLinksWorksInSubscriptions
 * Description: This test case is to verify whether the 'Next' and 'Previous' buttons
 * function properly for a subscribed channel under subscriptions screen
 * by logging into Comcast application.
 */

public class VerifyVideosNextAndPreviousLinksWorksInSubscriptions extends BaseTest{
	...
	@Test
	public void testVerifyVideosNextAndPreviousLinksWorksInSubscriptions() throws Exception {
